...
function! FuzzyFileFinder()
    ...
    execute "silent !find . -type d \\( -name node_modules -o -name .git -o -name dist -o -name *cache* -o -name android -o -name ios -o -name .next -o -name plugger -o -name .nx \\) -prune -o -type f | fz -p 'Files>' | sed 's/$/:0:0/' > " . l:tmpfile
    set efm=%f:%l:%c
