...
def Find(cmd_arg: string, cmd_complete: bool): list<string>
    if empty(files_cache)
        var cmd = 'find . -type d \( -name node_modules -o -name .git -o -name dist -o -name *_cache -o -name __pycache__ -o -name android -o -name ios -o -name .next \) -prune -o -type f -print'
